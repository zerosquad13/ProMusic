...
async def generate_cover(title, thumbnail, ctitle):
    ...
    font = ImageFont.truetype("ImageFont/Roboto-Light.ttf", 52)
    font2 = ImageFont.truetype("ImageFont/Roboto-Medium.ttf", 76)
...
@Client.on_message(command(["ytplay", f"play@{BOT_USERNAME}"]) & other_filters)
